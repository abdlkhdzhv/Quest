...
const Banner: React.FC = () => {
  ...
  return (
    <div className={style.banner}>
      ...
      <p>
        Квесты в Москве — отличная возможность для отдыха с семьёй и<br /> друзьями. Самое время выбраться из комнаты! Квесты в реальности — <br />одно из самых популярных развлечений в Москве. У нас вы найдёте<br /> информацию о лучших квест-комнатах от разных компаний!
      </p>
      <div className={style.filters}>
        {/* Фильтр для типа квеста */}
        <select className={style.selectPlayers} onChange={(e: { target: { value: string; }; }) => handleChange('questType', e.target.value)} value={filters.questType}>
        ...
        <select className={style.selectPlayers} onChange={(e: { target: { value: string; }; }) => handleChange('players', e.target.value)} value={filters.players}>
        ...
        <input
          ...
          onChange={(e: { target: { value: string; }; }) => handleChange('date', e.target.value)}
          value={filters.date}
        />
        ...
        <input
          type="time"
          className={style.inputDate}
          onChange={(e: { target: { value: string; }; }) => handleChange('time', e.target.value)}
          value={filters.time}
        />
